<?php
  ...
  class DatabaseHandler
  {
    ...
    {
        /*$database_handler = new PDO(PDO_DSN, DB_USERNAME, DB_PASSWORD,
            array(PDO::ATTR_PERSISTENT => DB_PERSISTENCY, PDO::MYSQL_ATTR_INIT_COMMAND => "SET NAMES utf8"));
        $attributes = array(
...
foreach ($attributes as $val) {
    echo "PDO::ATTR_$val: ";
    echo $database_handler->getAttribute(constant("PDO::ATTR_$val")) . "\n";
}*/
/*$conn = new PDO("sqlsrv:Server=localhost;Database=PortalDB", "sa", "123");
