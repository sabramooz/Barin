...
<section class="top-content container">
        <div class="slide-show col-md-7">
            ...
            overflow: hidden;">
                    <div>
                        <a u=image href="#"><img src="http://127.0.0.1/barin/view/front/images/1.jpg" /></a>
                    </div>
                    <div>
                        <a u=image href="#"><img src="http://127.0.0.1/barin/view/front/images/2.jpg" /></a>
                    </div>
                    <div>
                        <a u=image href="#"><img src="http://127.0.0.1/barin/view/front/images/3.jpg" /></a>
                    </div>
                    <div>
                        <a u=image href="#"><img src="http://127.0.0.1/barin/view/front/images/4.jpg" /></a>
                    </div>
                </div>
